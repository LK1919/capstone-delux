...
class AviatorActivity : AppCompatActivity(), SurfaceHolder.Callback, AREventListener {
  ...
  private fun initializeFilters() {
    effects = ArrayList()
//    effects!!.add("none")
    effects!!.add("aviator_test.deepar")
...
//    }
    ...
    quickAppointmentBtn.setOnClickListener {
      startActivity(Intent(this@AviatorActivity, AppointmentActivity::class.java))
    }
