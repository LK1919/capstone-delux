...
import ai.deepar.deepar_example.camera.TitaniumActivity
...
class TitaniumGlasses : AppCompatActivity() {
  @SuppressLint("MissingInflatedId")
  override fun onCreate(savedInstanceState: Bundle?) {
    super.onCreate(savedInstanceState)
    enableEdgeToEdge()
    setContentView(R.layout.activity_titanium_glasses)
    ...
    val virtualTO2 = findViewById<Button>(R.id.virtualTryOn2)
    virtualTO2.setOnClickListener {
      ...
      builder.setPositiveButton("Yes") { dialog, which ->
        ...
        startActivity(Intent(this@TitaniumGlasses, TitaniumActivity::class.java))
      }
