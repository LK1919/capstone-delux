...
class RayBanGlasses : AppCompatActivity() {
  @SuppressLint("MissingInflatedId")
  override fun onCreate(savedInstanceState: Bundle?) {
    super.onCreate(savedInstanceState)
    enableEdgeToEdge()
    setContentView(R.layout.activity_rayban_glasses)
    ...
    val virtualTO = findViewById<Button>(R.id.virtualTryOn)
    virtualTO.setOnClickListener {
      ...
      builder.setPositiveButton("Yes") { dialog, which ->
        ...
        startActivity(Intent(this@RayBanGlasses, MainActivity::class.java))
      }
